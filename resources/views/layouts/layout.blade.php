...
<head>
    ...
    <link href="{{ url('assets/css/mystyle.css')}}" rel="stylesheet"></head>
    <link href="{{ url('assets/css/style.css')}}" rel="stylesheet"></head>
    <link href="{{ asset('css/inputimage.css')}}" rel="stylesheet"></head>
    <link href="{{ asset('web/css/font-awesome.css')}}" rel="stylesheet"></head>
    <link href="https://cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css" rel="stylesheet"></head>
                        ...
                        <div class="app-footer">
                            <div class="app-footer__inner">
                                    ...
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="/" class="nav-link">
                                                IP2SR | Ikatan Pemuda Pemudi Sido Rukun
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="app-footer-right">
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="https://www.instagram.com/fuadz_fh/" class="nav-link">
                                                Develope with Laravel 8 by Fuadz
                                            </a>
                                        </li>
                                    </ul>
                                </div>
